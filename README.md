...
This is the code repository for the [Next.js Resource-Scheduling Calendar (Open-Source)](https://code.daypilot.org/13080/next-js-resource-scheduling-calendar-open-source) tutorial by [DayPilot](https://www.daypilot.org/).
